            ...
            children: <Widget>[
              ...
              FlatButton(
                ...
                onPressed: () async {
                  ...
                  if (game_data.kQuipsRooms ==
                      game_data.KQuipsRooms.question1) {
                    var answerRef = game_data.gameRoom
                        .child('questions')
                        .child(game_data.question1)
                        .child('answers')
                        .push();
                    answerRef.set(myAnswer.toJson());
                  } else if (game_data.kQuipsRooms ==
                      game_data.KQuipsRooms.question2) {
                    var answerRef = game_data.gameRoom
                        .child('questions')
                        .child(game_data.question2)
                        .child('answers')
                        .push();
                    answerRef.set(myAnswer.toJson());
                  }
                  ...
                  if (game_data.kQuipsRooms ==
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => KQuipsQuestion()));
                  } else {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => KQuipsWaitingRoom()));
                  }
                },
              ),
            ],
